...
public class ProductExtController {
    ...
    */
    ...
    {
        IPage<ProductExt> productExtIPage = productExtService.page(new Page<ProductExt>(query.getPage(), query.getSize()));
        return new PageList<ProductExt>(productExtIPage.getTotal(),productExtIPage.getRecords());
    }
}
